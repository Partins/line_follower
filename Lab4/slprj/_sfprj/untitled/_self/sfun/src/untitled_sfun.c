  ...
  nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"machine")) {
      ...
      ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2208036288U);
      ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(22550388U);
      ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(4000320909U);
      ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3685747137U);
    } else {
      return 0;
    }
  } else {
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2570270339U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2741370662U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3424522870U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(4019022219U);
  }
  ...
  nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 2:
      {
        if (strcmp(aiChksum, "1zbSJF4B0L4ph00YUFxCYD") == 0) {
  ...
  nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 2:
      {
        if (strcmp(tpChksum, "s6XUHxwDaIxT9bzhYep7dBF") == 0) {
